...
@section('css')
{!! Html::style(asset('assets/css/address.css')) !!}
@endsection
...
{!! Form::open() !!}
	...
	@endif
	<div class=" address-wrap" id="border">
	<div class="group field-sep input-wrap">
	...
	<div class="group field-sep">
		...
		{!! Form::text('address_line_two', Input::old('address_line_two') !== null ? Input::old('address_line_two') : null,['class'=>'form-control','placeholder'=>'address line 2']) !!}
	</div>
	<div class="group field-sep">
